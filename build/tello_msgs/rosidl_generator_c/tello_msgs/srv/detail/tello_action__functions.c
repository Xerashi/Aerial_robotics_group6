  ...
  tello_msgs__srv__TelloAction_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tello_msgs__srv__TelloAction_Request * data =
      (tello_msgs__srv__TelloAction_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tello_msgs__srv__TelloAction_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tello_msgs__srv__TelloAction_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  tello_msgs__srv__TelloAction_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tello_msgs__srv__TelloAction_Response * data =
      (tello_msgs__srv__TelloAction_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tello_msgs__srv__TelloAction_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tello_msgs__srv__TelloAction_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
