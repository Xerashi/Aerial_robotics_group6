...
class FlightData(metaclass=Metaclass_FlightData):
    ...
    def baro(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'baro' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._baro = value
    ...
    def agx(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'agx' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._agx = value
    ...
    def agy(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'agy' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._agy = value
    ...
    def agz(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'agz' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._agz = value
